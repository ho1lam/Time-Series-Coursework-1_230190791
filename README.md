...
## Description
The project explores trends and seasonality in tourism data from 2004 to 2025. 
It also investigates the significant impact of COVID-19 as a structural break in the time series.

## Methods
- Time series visualisation
- STL decomposition
- Prophet forecasting model
- Full-sample vs Pre-COVID models comparison
